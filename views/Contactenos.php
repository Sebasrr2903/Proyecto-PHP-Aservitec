...
<body class="u-body u-xl-mode" data-lang="es">
  ...
  <section class="u-align-center u-clearfix u-container-align-center u-gradient u-section-1" id="carousel_3674"
    ...
    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
      ...
      <div class="u-form u-radius-20 u-white u-form-1">
        <form action="https://forms.nicepagesrv.com/v2/form/process"
          ...
          style="padding: 28px;">
          <p class="u-align-center u-form-group u-form-text u-text u-text-2"> &nbsp;​​​Envíenos un mensaje y nos
            pondremos en contacto con usted lo antes posible. También puede comunicarse con nosotros por teléfono al
            (506) 4568-7893.
            A la espera de saber de ti.</p>
          <div class="u-form-group u-form-name">
            <label for="name-4c18" class="u-label">Nombre</label>
            <input type="text" placeholder="Ingrese su Nombre" id="name-4c18" name="Name"
          ...
          <div class="u-form-email u-form-group">
            ...
            <input type="email" placeholder="Ingrese un email valido" id="email-4c18" name="email"
              class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle"
              required="">
          </div>
          <div class="u-form-group u-form-message">
            <label for="message-4c18" class="u-label">Mensaje</label>
            <textarea placeholder="Ingrese el mensaje" rows="4" cols="50" id="message-4c18" name="message"
              class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle"
              required=""></textarea>
          </div>
          <div class="u-align-right u-form-group u-form-submit">
            <a href="#"
              class="u-active-black u-border-active-palette-4-light-1 u-border-hover-palette-4-light-1 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-hover-black u-radius-10 u-btn-1">Enviar</a>
