...
function NavbarN(){
    ...
    echo'      <nav class="navbar navbar-expand-lg bg-dark navbar-light d-none
        ...
        <div class="w-100 d-flex justify-content-between">
            <div>
                ...
                <a class="navbar-sm-brand text-light
                    ...
                    href="mailto:info@company.com">Arsevitec@company.com</a>
                <i class="fa fa-phone mx-2"></i>
                <a class="navbar-sm-brand text-light
                    text-decoration-none" href="tel:010-020-0340">010-020-0340</a>
            </div>
            <div>
                <a class="text-light" href="https://fb.com/templatemo"
                    target="_blank" rel="sponsored"><i class="fab
                        fa-facebook-f fa-sm fa-fw me-2"></i></a>
                <a class="text-light" href="https://www.instagram.com/"
                    target="_blank"><i class="fab fa-instagram fa-sm
                        fa-fw me-2"></i></a>
                <a class="text-light" href="https://twitter.com/"
                    target="_blank"><i class="fab fa-twitter fa-sm fa-fw
                        me-2"></i></a>
                <a class="text-light" href="https://www.linkedin.com/"
                    target="_blank"><i class="fab fa-linkedin fa-sm
                        fa-fw"></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill
            ...
            <div class="flex-fill">
                <ul class="nav navbar-nav d-flex justify-content-between
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Solicitud.php">Solicitud
                            de Matenimiento</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="view/Contactenos.php">Contactenos</a></li>
                            <li><a class="dropdown-item" href="#">Quienes
                                    Somos?</a></li>
            ...
            <div class="nav-item dropdown">
                ...
                <a href="carrito.php" id="procesar-pedido" class="button-pedido">Procesar Compra</a>
            </div>
            </div>
